...
//var server_url = "http://69.164.214.37:8080"+serverContext;
var server_url = "http://localhost:8080"+serverContext;
/******************************************************************************************************************/
...
var thaali_pakawnaar = ["Taher bhai Adenwala","Khadija Behen Rangwala","Durriya ben Chinwala", "Zainab ben Contractor", "Umema ben Kothari", "Tasneem ben Mithaiwala", "Zainab ben Dohadwala", "Farzana ben(Caterer)", "Jumana ben Shakir", "Zainab ben Saeed", "Fatema ben Khambaty", "Nisreen ben Mun", "Kherun ben Merchant"];
...
onLoadUserThaaliView = function(){
    ...
    //Hiding the userThaaliCategory column for smaller screen sizes (Esp mobile phones)..    
    if($('#markerDivForMobile').css('display') == 'block'){    	
    	$("#jqxUserThaaliDataGrid").jqxGrid('hidecolumn', 'userThaaliCategory');
    }
    ...
    $("#jqxUserThaaliDataGrid").bind('cellbeginedit', function (event) {
        ...
        //If not signed up earlier show message..
        ...
        if(isLocked == true){
        	//Means user had not signedup for thaali earlier. He/She cannot make modifications at this time.
